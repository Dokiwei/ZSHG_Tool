...
@Composable
fun OccupationScreen(navController: NavHostController, backToInformation: () -> Unit) {
    ...
    Scaffold(
        topBar = {
            MyCenterAlignedBackTopAppBar(MyRoute.InformationRoute.OCCUPATION, backToInformation)
        }
    ) {
        Box(modifier = Modifier.padding(it)) {
            Card(
                ...
                SearchBar(roles, viewModel, items, navController) { backToInformation() }
            }
            LazyColumn {
                items.forEach {
                    item {
                            ...
                            modifier = Modifier
                                .clickable(
                                    onClick = {
                                        ...
                                        navController.navigate("详细页/$role")
                                    })
                        )
                        Divider()
                    }
